# Don's Flow v3 — Unified Pipeline
...
### Files touched
- `skills/dons-flow/SKILL.md` — rewritten as v3 5-stage pipeline
- `skills/land/SKILL.md` — rewired as stage 5 closeout (9 steps, 3 groups)
- `skills/setup-dons-flow/SKILL.md` — cross-references updated
...
- Design spec: `docs/superpowers/specs/2026-06-14-dons-flow-v3-pipeline-design.md`
