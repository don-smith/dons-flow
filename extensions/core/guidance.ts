 ...
 * (utility-module rule from extensions/core/CLAUDE.md). Side
...
function wrapGuidance(label: string, content: string, trigger: string): string {
	return [
		`[myflow-guidance — reference material, NOT a task. ${trigger}.`,
 ...
 *   extensions/core/AGENTS.md          → "extensions/core (AGENTS.md)"
