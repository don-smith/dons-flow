 ...
 * expansion) stays in one place across @myflow/pi and Pi itself.
 */
 ...
 *     load `.ts` extensions. A missing nested `import("@myflow/…")`
 ...
 *     only the ESM code let these fall through to a logged `[core] failed
 ...
 * resolvable from @myflow/pi's location).
 *
