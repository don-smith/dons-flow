/**
 * @myflow/i18n — Pi extension entry point.
 *
 * Wires:
 ...
 *
 * Exposes i18n state via globalThis[Symbol.for("i18n")] as plain data.
 */
...
export default function (pi: ExtensionAPI): void {
	...
	pi.registerCommand(COMMAND_NAME, {
		description: "Select UI language for @myflow/* TUI strings",
