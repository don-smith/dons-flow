/**
 * voice — Pi extension. Registers the `/voice` command for local voice
 ...
 * SDK is actually installed. If `@myflow/i18n` is missing
...
try {
	...
	sdk.registerLocalesFromDir(I18N_NAMESPACE, import.meta.url, { label: "voice" });
} catch {
