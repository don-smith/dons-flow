 ...
 * errors. Packages like `@myflow/pi` opt in by calling
 ...
 * Pi may load this module more than once — once for the workflow
 * extension itself, and once via the @myflow/pi `import { registerBuiltIns }
 * from "@myflow/workflow"` cross-package resolution — and
...
const REGISTRY_KEY = Symbol.for("@myflow/workflow:built-ins");
const PROVIDERS_KEY = Symbol.for("@myflow/workflow:built-in-providers");
const FLUSH_KEY = Symbol.for("@myflow/workflow:built-in-flush");
