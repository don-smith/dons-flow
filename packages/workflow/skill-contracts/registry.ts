...
const REGISTRY_KEY = Symbol.for("@myflow/workflow:skill-contracts");
const PROVIDERS_KEY = Symbol.for("@myflow/workflow:skill-contract-providers");
const FLUSH_KEY = Symbol.for("@myflow/workflow:skill-contract-flush");
const FAILURES_KEY = Symbol.for("@myflow/workflow:skill-contract-failures");
const COLLISIONS_KEY = Symbol.for("@myflow/workflow:skill-contract-collisions");
const OWNERS_KEY = Symbol.for("@myflow/workflow:skill-contract-owners");
 ...
 *
 * `owner` (optional consumer label, e.g. `"@myflow/pi"`) makes two real-world cases
 * safe:
