 ...
 *   - **Global** — sibling extensions (@myflow/pi widget, future metrics)
 ...
 * ```ts
 * import { runWorkflow, type LifecycleListeners } from "@myflow/workflow";
 *
 ...
 * ```ts
 * import { registerLifecycle } from "@myflow/workflow";
 *
 ...
 */
const REGISTRY_KEY = Symbol.for("@myflow/workflow:lifecycle");
