 ...
 *
 *   - @myflow/pi's regression test that exercises `recordStage` directly
 ...
 * `@myflow/workflow/internal` via the package's `exports`
 * field — keep that path stable so the @myflow/pi test + repo-wide
 * setup don't break.
 *
