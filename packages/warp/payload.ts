/**
 * warp — Warp structured-payload composition.
 *
 ...
 * `args` and Pi's built-in skill expander) back to the user-facing
 ...
 * notification. Inverse of the wrapper builder in `args/args.ts:205`.
 */
