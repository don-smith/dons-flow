 ...
 *
 * globalThis-keyed (Symbol.for("advisor")) so the cache survives module
 * re-import on /new, /fork, /resume (mirrors btw/btw.ts). Single-slot — the
...
const ADVISOR_STATE_KEY = Symbol.for("advisor");
